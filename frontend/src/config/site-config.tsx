...
export const navbarLinks = [
  {
    href: `https://github.com/PhantomDave/${basePath}`,
    event: "GitHub",
  ...
  {
    href: `https://github.com/PhantomDave/${basePath}/blob/main/CHANGELOG.md`,
    event: "Changelog",
  ...
  {
    href: `https://github.com/PhantomDave/${basePath}/discussions`,
    event: "Discussions",
