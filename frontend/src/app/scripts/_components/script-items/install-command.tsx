...
function getInstallCommand(scriptPath = "", isAlpine = false, useGitea = false) {
  const githubUrl = `https://raw.githubusercontent.com/PhantomDave/${basePath}/main/${scriptPath}`;
  const giteaUrl = `https://git.PhantomDave.org/PhantomDave/${basePath}/raw/branch/main/${scriptPath}`;
