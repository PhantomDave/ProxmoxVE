...
export const metadata: Metadata = {
  ...
  authors: [
    ...
    { name: "Community Scripts", url: "https://github.com/PhantomDave" },
  ],
  creator: "Bram Suurd",
  publisher: "Community Scripts",
  metadataBase: new URL(`https://PhantomDave.github.io/${basePath}/`),
  alternates: {
    canonical: `https://PhantomDave.github.io/${basePath}/`,
  },
  viewport: {
    width: "device-width",
    initialScale: 1,
  ...
  openGraph: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) repository. Featuring over 400+ scripts to help you manage your Proxmox Virtual Environment.",
    url: `https://PhantomDave.github.io/${basePath}/`,
    siteName: "Proxmox VE Helper-Scripts",
    images: [
      {
        url: `https://PhantomDave.github.io/${basePath}/defaultimg.png`,
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "The official website for the Proxmox VE Helper-Scripts (Community) repository. Featuring over 400+ scripts to help you manage your Proxmox Virtual Environment.",
    images: [`https://PhantomDave.github.io/${basePath}/defaultimg.png`],
  },
