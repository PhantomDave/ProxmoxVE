...
service:
  ...
  PhantomDave/ProxmoxVE:
    latest_version:
      type: github
      url: PhantomDave/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/PhantomDave/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/PhantomDave/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
